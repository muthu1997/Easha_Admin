...
export default function BankListScreen(props) {
            ...
            <TouchableOpacity activeOpacity={0.8} style={styles.cardContainer}>
                <View style={styles.itemBottom}>
                    <View style={[styles.dataContainer, { width: "100%" }]}>
                            ...
                            <TouchableOpacity onPress={() => props.navigation.navigate("UpdateBankData", { data: item })} style={styles.roundButton}>
                    ...
                    <View style={[styles.dataContainer, { width: "100%" }]}>
                        ...
                        <Text type="paragraph" title={`${String(item.acc_no).slice(0,4)}********`} style={{ color: COLOUR.GRAY }} />
                    </View>
                    <View style={[styles.dataContainer, { width: "100%" }]}>
            ...
            <View style={styles.mainContainer}>
                <FlatList
                    ...
                    ListEmptyComponent={() => {
                        ...
                        <Text type="paragraph" title={"No payout options added. Press + icon to add new payout option."} style={{ color: COLOUR.DARK_GRAY, textAlign: "center" }} />
                        </View>
                    }}
